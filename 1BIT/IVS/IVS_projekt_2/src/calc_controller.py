...
#@author David Hurta
#@brief This package includes class for handling calculator
...
class Calculator_Controller(QMainWindow, Ui_MainWindow_Calculator):
    ...
    ## @class showWindowHelp(self)
    # @brief Shows window including help for user
    ...
    ## @class numberClicked(self)
    # @brief Handles clicking on numbers buttons
    ...
    ## @class dotClicked(self)
    # @brief Handles clicking on dot button
    def dotClicked(self):
        buttonClicked = self.sender()
        display = self.textBoxDisplay
    ...
    ## @class unaryOperatorClicked(self)
    # @brief Handles clicking on unary operator's button
    ...
    ## @class binaryOperatorClicked(self)
    # @brief Handles clicking on binary operator's button
    ...
    ## @class equalClicked(self)
    # @brief Handles clicking on equal button
    ...
    ## @class clearClicked(self)
    # @brief Handles clicking on clear button
